...
class RegionalAggregator(AeroMAPSModel):
    ...
    def from_yaml_config(
        ...
        """
        Create a RegionalAggregator from the full regionalisation YAML configuration.

        This factory method extracts the aggregation section from the full
        regionalisation configuration file.
        ...
        regions
            List of region identifiers.
        yaml_config
            The full regionalisation YAML configuration dictionary.
        parameters
            AeroMAPS process parameters (optional).
        ...
        """
        aggregation_config = yaml_config.get("aggregation", {})
        global_namespace = yaml_config.get("global_namespace", "overall")
