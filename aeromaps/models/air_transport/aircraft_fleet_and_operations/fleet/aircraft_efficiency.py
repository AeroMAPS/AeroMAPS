...
class PassengerAircraftEfficiencySimple(AeroMAPSModel):
    ...
    def compute(
        ...
        hydrogen_introduction_year_short_range: float,
        hydrogen_final_market_share_medium_range: float,
        hydrogen_introduction_year_medium_range: float,
        hydrogen_final_market_share_long_range: float,
        hydrogen_introduction_year_long_range: float,
        electric_final_market_share_short_range: float,
        electric_introduction_year_short_range: float,
        electric_final_market_share_medium_range: float,
        electric_introduction_year_medium_range: float,
        electric_final_market_share_long_range: float,
        electric_introduction_year_long_range: float,
...
class FreightAircraftEfficiency(AeroMAPSModel):
    ...
    def compute(
        ...
        self.df.loc[:, "rtk_electric_share"] = rtk_hydrogen_share
        ...
        self.df.loc[:, "rtk_electric"] = rtk_hydrogen
