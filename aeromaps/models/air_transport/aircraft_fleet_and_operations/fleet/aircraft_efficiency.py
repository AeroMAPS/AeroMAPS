...
class PassengerAircraftEfficiencySimple(AeroMAPSModel):
    ...
    def compute(
        ...
        hydrogen_introduction_year_short_range: int = 0.0,
        hydrogen_final_market_share_medium_range: float = 0.0,
        hydrogen_introduction_year_medium_range: int = 0.0,
        hydrogen_final_market_share_long_range: float = 0.0,
        hydrogen_introduction_year_long_range: int = 0.0,
        electric_final_market_share_short_range: float = 0.0,
        electric_introduction_year_short_range: int = 0.0,
        electric_final_market_share_medium_range: float = 0.0,
        electric_introduction_year_medium_range: int = 0.0,
        electric_final_market_share_long_range: float = 0.0,
        electric_introduction_year_long_range: int = 0.0,
