...
class Fleet(object):
    ...
    def _build_default_fleet(self, add_examples_aircraft_and_subcategory=True):
        ...
        sr_nb_cat.old_reference_aircraft.doc_non_energy_base = 0.045 * (0.9 + 0.1 *(0.07/0.04)) # conversion of capital to 0.07 annuity factor (US based airlines very low)
        ...
        sr_nb_cat.recent_reference_aircraft.doc_non_energy_base = 0.045 * (0.9 + 0.1 *(0.07/0.04)) # conversion of capital to 0.07 annuity factor (US based airlines very low)
        ...
        mr_subcat.old_reference_aircraft.doc_non_energy_base = 0.028 * (0.9 + 0.1 *(0.07/0.04)) # conversion of capital to 0.07 annuity factor (US based airlines very low)
        ...
        mr_subcat.recent_reference_aircraft.doc_non_energy_base = 0.028 * (0.9 + 0.1 *(0.07/0.04)) # conversion of capital to 0.07 annuity factor (US based airlines very low)
        ...
        lr_subcat.old_reference_aircraft.doc_non_energy_base = 0.023 * (0.9 + 0.1 *(0.07/0.04)) # conversion of capital to 0.07 annuity factor (US based airlines very low)
        ...
        lr_subcat.recent_reference_aircraft.doc_non_energy_base = 0.023 * (0.9 + 0.1 *(0.07/0.04)) # conversion of capital to 0.07 annuity factor (US based airlines very low)
