...
class FuelEffectCorrectionContrails(AeroMAPSModel):
    ...
    def compute(
        self,
        total_aircraft_distance_dropin_fuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        total_aircraft_distance: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        total_aircraft_distance_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        total_aircraft_distance_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
