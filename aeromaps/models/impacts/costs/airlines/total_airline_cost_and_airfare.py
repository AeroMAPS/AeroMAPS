...
class PassengerAircraftTotalCostAirfare(AeromapsModel):
    def __init__(self, name="passenger_aircraft_total_cost_and_airfare", fleet_model=None, *args, **kwargs):
    ...
    def compute(
        ...
        total_cost_per_ask_without_extra_tax = (
            doc_non_energy_per_ask_mean+doc_energy_per_ask_mean+non_operating_cost_per_ask+indirect_operating_cost_per_ask+noc_carbon_offset_per_ask
        )

        # Tax revenue
        total_extra_tax_per_ask = (doc_carbon_tax_lowering_offset_per_ask_mean+passenger_tax_per_ask)
