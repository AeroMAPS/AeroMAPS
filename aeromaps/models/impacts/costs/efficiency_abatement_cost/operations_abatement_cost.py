...
class OperationsAbatementCost(AeromapsModel):
    ...
    def compute(
        ...
        emissions_reduction_operations = (energy_per_ask_without_operations_total*operations_gain * kerosene_emission_factor / 1000000)
        extra_cost_operations = (operational_efficiency_cost_per_ask - energy_per_ask_without_operations_total*operations_gain *  kerosene_market_price / fuel_lhv)
