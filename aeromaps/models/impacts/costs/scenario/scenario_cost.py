...
class TotalAirlineCost(AeroMAPSModel):
    ...
    def compute(
        ...
        cumulative_total_airline_cost_discounted = cummulative_total_airline_cost / (1 + social_discount_rate) ** (
                self.df.index - self.prospection_start_year
        )

        self.df.loc[:, "total_airline_cost"] = total_airline_cost
        self.df.loc[:, "cummulative_total_airline_cost"] = cummulative_total_airline_cost
        self.df.loc[:, "cumulative_total_airline_cost_discounted"] = cumulative_total_airline_cost_discounted

        return (
            total_airline_cost,
            cummulative_total_airline_cost,
...
class TotalSurplusLoss(AeroMAPSModel):
    ...
    def compute(
        ...
        self.df.loc[:, "cumulative_total_surplus_loss_discounted"] = cumulative_total_surplus_loss_discounted

        return (
            cummulative_total_surplus_loss,
