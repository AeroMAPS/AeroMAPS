...
class NonDiscountedScenarioCost(AeroMAPSModel):
    ...
    def compute(
        self,
        kerosene_cost: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_cost_hefa_fog: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_cost_hefa_others: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_cost_ft_others: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_cost_ft_msw: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_cost_atj: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrofuel_total_cost: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        total_hydrogen_supply_cost: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
