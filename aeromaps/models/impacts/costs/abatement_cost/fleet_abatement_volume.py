# @Time : 05/02/2024 16:24
# @Author : a.salgas
# @File : fleet_abatement_volume.py
# @Software: PyCharm
import pandas as pd
...
class FleetCarbonAbatementCost(AeromapsModel):
    def __init__(
            self, name="recurring_costs", fleet_model=None, *args, **kwargs
    ):
        ...
        for category, sets in self.fleet_model.all_aircraft_elements.items():
            ...
            for aircraft_var in sets:
                ...
                rc_aircraft_var_name = (
                        aircraft_var_name + ":aircraft_recurring_costs"
                )
