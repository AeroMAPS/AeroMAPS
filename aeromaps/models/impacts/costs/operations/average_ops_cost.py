...
class PassengerAircraftDocEnergy(AeromapsModel):
    ...
    def compute(
        ...
        doc_energy_per_ask_long_range_dropin_fuel = energy_per_ask_long_range_dropin_fuel * dropin_mean_mfsp / fuel_lhv
        doc_energy_per_ask_long_range_hydrogen = energy_per_ask_long_range_hydrogen * h2_avg_cost_per_kg / hydrogen_specific_energy
        doc_energy_per_ask_long_range_mean = doc_energy_per_ask_long_range_hydrogen * ask_long_range_hydrogen_share / 100 + \
                                             doc_energy_per_ask_long_range_dropin_fuel * ask_long_range_dropin_fuel_share / 100

        doc_energy_per_ask_medium_range_dropin_fuel = energy_per_ask_medium_range_dropin_fuel * dropin_mean_mfsp / fuel_lhv
        doc_energy_per_ask_medium_range_hydrogen = energy_per_ask_medium_range_hydrogen * h2_avg_cost_per_kg / hydrogen_specific_energy
        doc_energy_per_ask_medium_range_mean = doc_energy_per_ask_medium_range_hydrogen * ask_medium_range_hydrogen_share / 100 + \
                                               doc_energy_per_ask_medium_range_dropin_fuel * ask_medium_range_dropin_fuel_share / 100

        doc_energy_per_ask_short_range_dropin_fuel = energy_per_ask_short_range_dropin_fuel * dropin_mean_mfsp / fuel_lhv
        doc_energy_per_ask_short_range_hydrogen = energy_per_ask_short_range_hydrogen * h2_avg_cost_per_kg / hydrogen_specific_energy
        doc_energy_per_ask_short_range_mean = doc_energy_per_ask_short_range_hydrogen * ask_short_range_hydrogen_share / 100 + \
                                              doc_energy_per_ask_short_range_dropin_fuel * ask_short_range_dropin_fuel_share / 100

        doc_energy_per_ask_mean = (doc_energy_per_ask_long_range_mean * ask_long_range +
...
class DropInMeanMfsp(AeromapsModel):
    def __init__(
            self, name="dropin_mean_mfsp", fleet_model=None, *args, **kwargs
    ):
        super().__init__(name=name, *args, **kwargs)
        self.fleet_model = fleet_model
