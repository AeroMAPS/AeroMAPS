...
class BiofuelCost(AeroMAPSModel):
    ...
    def compute(
        ...
        biofuel_hefa_fog_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_others_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_ft_others_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_ft_msw_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_atj_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ...
        biofuel_hefa_fog_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_fog_var_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_fog_feedstock_cost: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_others_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_others_var_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_others_feedstock_cost: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_fuel_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_oil_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_ft_others_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_ft_others_var_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_ft_others_feedstock_cost: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_ft_msw_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_ft_msw_feedstock_cost: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_ft_msw_var_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_ft_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_atj_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_atj_var_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_atj_feedstock_cost: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_atj_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
    ...
    def _pathway_computation(
        ...
        kerosene_market_price: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_biofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biomass_feedstock_cost: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_eis_var_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_eis_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        plant_eis_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        exogenous_carbon_price_trajectory: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        plant_lifespan: float = 0.0,
        private_discount_rate: float = 0.0,
        social_discount_rate: float = 0.0,
