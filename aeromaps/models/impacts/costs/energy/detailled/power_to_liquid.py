...
class ElectrofuelCost(AeroMAPSModel):
    ...
    def compute(
        ...
        electrofuel_eis_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrofuel_eis_fixed_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrofuel_eis_var_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ...
        co2_market_price: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrofuel_eis_specific_co2: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
    ...
    def _electrofuel_computation(
        ...
        electrofuel_eis_fixed_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrofuel_eis_var_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        # electrofuel_eis_specific_energy: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrolysis_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrofuel_hydrogen_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electricity_market_price: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_electrofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
