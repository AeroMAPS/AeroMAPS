...
class LiquidHydrogenCost(AeroMAPSModel):
    ...
    def compute(
        ...
        electrolysis_h2_eis_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrolysis_h2_eis_fixed_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrolysis_h2_eis_var_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrolysis_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        gas_ccs_eis_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        gas_ccs_eis_fixed_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        gas_ccs_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        gas_ccs_load_factor: float = 0.0,
        liquid_hydrogen_gas_ccs_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        gas_eis_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        gas_eis_fixed_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        gas_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        gas_load_factor: float = 0.0,
        liquid_hydrogen_gas_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        coal_ccs_eis_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        coal_ccs_eis_fixed_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        coal_ccs_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        coal_ccs_load_factor: float = 0.0,
        liquid_hydrogen_coal_ccs_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        coal_eis_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        coal_eis_fixed_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        coal_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        coal_load_factor: float = 0.0,
        liquid_hydrogen_coal_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        liquefier_eis_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ...
        liquid_hydrogen_electrolysis_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electricity_market_price: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        gas_market_price: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        coal_market_price: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ccs_cost: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electricity_load_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ...
        exogenous_carbon_price_trajectory: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
    ...
    def _electrolysis_computation(
        ...
        electricity_market_price: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        pathway_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electricity_load_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        plant_lifespan: float = 0.0,
        private_discount_rate: float = 0.0,
        social_discount_rate: float = 0.0,
    ...
    def _fossil_computation(
        self,
        plant_eis_capex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        plant_eis_fixed_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        # plant_eis_var_opex: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        plant_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        fuel_market_price: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ccs_cost: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        pathway_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        plant_load_factor: float = 0.0,
        emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        emission_factor_without_ccs: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        plant_lifespan: float = 0.0,
        private_discount_rate: float = 0.0,
        social_discount_rate: float = 0.0,
        lhv_hydrogen: float = 0.0,
    ...
    def _unitary_avoided_cumul_emissions(
        self,
        avoided_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        exogenous_carbon_price_trajectory: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        plant_lifespan: float = 0.0,
        lhv_hydrogen: float = 0.0,
        social_discount_rate: float = 0.0,
