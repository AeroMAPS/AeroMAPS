...
class TemperatureGWPStar(AeroMAPSModel):
    ...
    def compute(
        ...
        nox_short_term_o3_increase_erf: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        nox_long_term_o3_decrease_erf: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        nox_ch4_decrease_erf: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        nox_stratospheric_water_vapor_decrease_erf: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ...
        total_erf: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
