...
class ImpactsParameters(object):
    ...
    relative_doc_non_energy_per_ask_hydrogen_wrt_dropin_short_range: float = 0.1,
    relative_doc_non_energy_per_ask_hydrogen_wrt_dropin_medium_range: float = 0.1,
    relative_doc_non_energy_per_ask_hydrogen_wrt_dropin_long_range: float = 0.1,
