...
class KayaFactors(AeroMAPSModel):
    ...
    def compute(
        ...
        energy_consumption: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        kerosene_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_mean_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrofuel_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        liquid_hydrogen_mean_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
...
class CO2Emissions(AeroMAPSModel):
    ...
    def compute(
        ...
        rtk: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        load_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ...
        ask_short_range_dropin_fuel_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ask_medium_range_dropin_fuel_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ask_long_range_dropin_fuel_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        rtk_dropin_fuel_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ask_short_range_hydrogen_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ask_medium_range_hydrogen_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ask_long_range_hydrogen_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        rtk_hydrogen_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ask_short_range_electric_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ask_medium_range_electric_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ask_long_range_electric_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        rtk_electric_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        kerosene_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_mean_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrofuel_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        liquid_hydrogen_mean_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electricity_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_mean: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_rtk_mean: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        co2_per_energy_mean: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
...
class DetailedCo2Emissions(AeroMAPSModel):
    ...
    def compute(
        self,
        rpk_reference: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        rtk_reference: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        rpk: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        rtk: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        load_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_mean: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_rtk_mean: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_mean_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_rtk_mean_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        co2_per_energy_mean: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
    ) -> Tuple[pd.Series, pd.Series, pd.Series, pd.Series, pd.Series, pd.Series]:
...
class DetailedCumulativeCO2Emissions(AeroMAPSModel):
    ...
    def compute(
        self,
        co2_emissions_2019technology_baseline3: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        co2_emissions_2019technology: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        co2_emissions_including_load_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        co2_emissions_including_energy: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
