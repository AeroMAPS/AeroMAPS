...
class DropInFuelConsumption(AeroMAPSModel):
    ...
    def compute(
        ...
        energy_per_rtk_without_operations_freight_dropin_fuel: pd.Series = pd.Series(dtype="float64"),
...
class EnergyConsumption(AeroMAPSModel):
    ...
    def compute(
        self,
        energy_consumption_short_range_biofuel_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_medium_range_biofuel_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_long_range_biofuel_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_passenger_biofuel_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_freight_biofuel_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_short_range_electrofuel_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_medium_range_electrofuel_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_long_range_electrofuel_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_passenger_electrofuel_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_freight_electrofuel_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_short_range_kerosene_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_medium_range_kerosene_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_long_range_kerosene_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_passenger_kerosene_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_freight_kerosene_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_short_range_hydrogen_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_medium_range_hydrogen_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_long_range_hydrogen_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_passenger_hydrogen_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_freight_hydrogen_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_short_range_electric_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_medium_range_electric_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_long_range_electric_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_passenger_electric_without_operations: pd.Series = pd.Series(dtype="float64"),
        energy_consumption_freight_electric_without_operations: pd.Series = pd.Series(dtype="float64"),
