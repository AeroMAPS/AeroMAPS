...
class DropInFuelConsumption(AeroMAPSModel):
    ...
    def compute(
        self,
        biofuel_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrofuel_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        kerosene_share: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ...
        rtk_dropin_fuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_without_operations_short_range_dropin_fuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_without_operations_medium_range_dropin_fuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_without_operations_long_range_dropin_fuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_rtk_without_operations_freight_dropin_fuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_short_range_dropin_fuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_medium_range_dropin_fuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_long_range_dropin_fuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_rtk_freight_dropin_fuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
    ) -> Tuple[
        pd.Series,
        pd.Series,
        pd.Series,
...
class HydrogenConsumption(AeroMAPSModel):
    ...
    def compute(
        ...
        rtk_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_without_operations_short_range_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_without_operations_medium_range_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_without_operations_long_range_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_rtk_without_operations_freight_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_short_range_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_medium_range_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_long_range_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_rtk_freight_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
    ) -> Tuple[
        pd.Series,
        pd.Series,
        pd.Series,
...
class ElectricConsumption(AeroMAPSModel):
    ...
    def compute(
        self,
        ask_short_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ask_medium_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ask_long_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        rtk_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_without_operations_short_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_without_operations_medium_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_without_operations_long_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_rtk_without_operations_freight_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_short_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_medium_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_ask_long_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_per_rtk_freight_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
    ) -> Tuple[
        pd.Series,
        pd.Series,
        pd.Series,
...
class EnergyConsumption(AeroMAPSModel):
    ...
    def compute(
        self,
        energy_consumption_short_range_biofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_medium_range_biofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_long_range_biofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_passenger_biofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_freight_biofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_short_range_electrofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_medium_range_electrofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_long_range_electrofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_passenger_electrofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_freight_electrofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_short_range_kerosene_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_medium_range_kerosene_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_long_range_kerosene_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_passenger_kerosene_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_freight_kerosene_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_short_range_hydrogen_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_medium_range_hydrogen_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_long_range_hydrogen_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_passenger_hydrogen_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_freight_hydrogen_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_short_range_electric_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_medium_range_electric_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_long_range_electric_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_passenger_electric_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_freight_electric_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_biofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_electrofuel_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_kerosene_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_hydrogen_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_electric_without_operations: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_short_range_biofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_medium_range_biofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_long_range_biofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_passenger_biofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_freight_biofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_short_range_electrofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_medium_range_electrofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_long_range_electrofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_passenger_electrofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_freight_electrofuel: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_short_range_kerosene: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_medium_range_kerosene: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_long_range_kerosene: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_passenger_kerosene: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_freight_kerosene: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_short_range_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_medium_range_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_long_range_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_passenger_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_freight_hydrogen: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_short_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_medium_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_long_range_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_passenger_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        energy_consumption_freight_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        ...
        energy_consumption_electric: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
    ) -> Tuple[
        pd.Series,
        pd.Series,
        pd.Series,
