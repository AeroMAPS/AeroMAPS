...
class DropinAbatementPotential(AeroMAPSModel):
    ...
    def compute(
        ...
        electricity_hydrogen_consumption: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electrolysis_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        electricity_electrofuel_consumption: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
...
class EnergyAbatementEffective(AeroMAPSModel):
    ...
    def compute(
        self,
        biofuel_atj_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biomass_atj_consumption: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        kerosene_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_atj_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biomass_hefa_fog_consumption: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_fuel_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_fog_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biomass_hefa_others_consumption: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_oil_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_hefa_others_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biomass_ft_consumption: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_ft_efficiency: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
        biofuel_ft_msw_emission_factor: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
