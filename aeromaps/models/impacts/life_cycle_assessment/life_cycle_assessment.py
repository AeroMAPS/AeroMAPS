...
import xarray as xr
from lca_modeller.io.configuration import LCAProblemConfigurator, KEY_MODEL
...
class LifeCycleAssessment(AeroMAPSModel):
    ...
    def _multi_lca_algebraic_raw(self, **params):
        ...
        for imethod, method in enumerate(methods):
            unit = bw.Method(method).metadata.get("unit", None)
            res.coords["impacts"].attrs.setdefault("units", {})[method] = unit
...
class LifeCycleAssessmentJSON(AeroMAPSModel):
    """
    ...
    def __init__(
        self,
        name: str = "life_cycle_assessment_json",
        json_file: str = None,
        split_by: str = None,
        *args,
        **kwargs,
