...
class EmissionsPerRPK(AeroMAPSModel):
    ...
    def compute(
        self,
        co2_emissions_passenger: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
...
class EmissionsPerRTK(AeroMAPSModel):
    ...
    def compute(
        self,
        co2_emissions_freight: pd.Series = pd.Series(dtype="float64", index=list(range(2000, 2051))),
